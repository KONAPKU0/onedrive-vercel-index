...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'konpaku@vip.qq.com',
  ...
  protectedRoutes: ['/电子邮件附件','/主储存','/临时储存','/个人','/Office Online 扩展','/Microsoft Edge Collections','/Documents'],
